...
class PagesController extends Controller
{
    ...
    public function dashboard(){
        ...
        $this->_data['usulan_pkm_lolos'] = count(UsulanPkm::where('status_usulan_id',StatusUsulan::where('keterangan','LOLOS')->first()->id)->get());
        $this->_data['usulan_pkm_tidak_lolos'] = count(UsulanPkm::where('status_usulan_id',StatusUsulan::where('keterangan','GAGAL')->first()->id)->get());
