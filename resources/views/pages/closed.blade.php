...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Coming Soon Flat - Robust - Responsive Bootstrap 4 Admin Dashboard Template for Web Application</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/template/robust/app-assets') }}/css/pages/coming-soon.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/template/robust/assets') }}/css/style.css">
    <!-- END Custom CSS-->
  </head>
  <body class="vertical-layout vertical-menu 1-column  comingsoonFlat menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-col="1-column">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
            ...
            <div class="card card-transparent box-shadow-0 border-0">
                <div class="card-content">
                    <div class="text-center">
                        <h5 class="card-text pb-2 white">MAAF SEMENTARA APLIKASI DITUTUP.</h5>
                        {{-- <img src="{{ asset('assets/template/robust/app-assets') }}/images/logo/logo-light-lg.png" class="img-responsive block width-300 mx-auto" width="300" alt="bg-img"> --}}
                        <div id="clockFlat" class="card-text getting-started pt-1 mt-2 white d-inline-block"></div>
                        <div class="col-12 pt-1">
                            <p class="card-text lead white">Untuk sementara aplikasi tidak diijinkan untuk digunakan hub whatsapp dibawah ini.</p>
                        </div>
                        <div class="col-12 text-center pt-2">
                            <p class="socialIcon card-text">
                              <a target="_blank" href="https://wa.me/6282226235238"><i class="fa fa-whatsapp white"></i></a>
                        ...
                        <div class="col-12 text-center pt-2">
                          <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg white btn-block">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!--/ coming soon flat design -->
    ...
    <script src="{{ asset('assets/template/robust/app-assets') }}/vendors/js/coming-soon/jquery.countdown.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{ asset('assets/template/robust/app-assets') }}/js/scripts/coming-soon/coming-soon.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>