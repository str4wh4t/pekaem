...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">Edit Target PKM Tahunan</h3>
    </div>
</div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('target-pkm-tahunan.update', $target) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="kode_fakultas" class="form-control" name="kode_fakultas" required>
                                            ...
                                            @foreach($fakultas_list as $fakultas)
                                                <option value="{{ $fakultas->kodeF }}" {{ old('kode_fakultas', $target->kode_fakultas) == $fakultas->kodeF ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="jumlah_mahasiswa_aktif" class="form-control" name="jumlah_mahasiswa_aktif" value="{{ old('jumlah_mahasiswa_aktif', $target->jumlah_mahasiswa_aktif) }}" placeholder="Jumlah Mahasiswa Aktif" min="0" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="target_usulan_pkm" class="form-control" name="target_usulan_pkm" value="{{ old('target_usulan_pkm', $target->target_usulan_pkm) }}" placeholder="Target Usulan PKM" min="0" required>
